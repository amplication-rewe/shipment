...
@InputType()
class ShipmentCreateNestedManyWithoutPackageModelsInput {
...
export { ShipmentCreateNestedManyWithoutPackageModelsInput as ShipmentCreateNestedManyWithoutPackageModelsInput };
