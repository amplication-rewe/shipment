...
@InputType()
class ShipmentCreateNestedManyWithoutDestinationsInput {
...
export { ShipmentCreateNestedManyWithoutDestinationsInput as ShipmentCreateNestedManyWithoutDestinationsInput };
